...
-- Tiempo de generación: 14-08-2024 a las 20:17:27
...
INSERT INTO `productos` (`id`, `nombre`, `codigo`, `stock`, `precio`, `categoria_id`) VALUES
(1, 'Gel Fijador', 'GF001', 12, 10000, 1),
(2, 'PEINE', '7841', 56, 1500, 1);
...
ALTER TABLE `productos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_poducto_categoria` (`categoria_id`);
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `fk_poducto_categoria` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
